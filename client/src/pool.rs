...
// prevents the need from having to spawn threads each time work needs to be executed
// with this a pool can be spawned on initalization and work can be executed faster
